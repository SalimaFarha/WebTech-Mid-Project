...
if(empty($_FILES["image"]["name"]))
{
   ...
   $fileErr= "<br>".$_FILES["image"]["name"];
    ...
    $fileName= "../uploads/".$_REQUEST["email"].".jpg";
}
if($haserror==0)
{
...
$mydb= new MyDB();
$conobj= $mydb->openCon();
$result=$mydb->insertData("student",$_REQUEST["firstname"],$_REQUEST["lastname"],$_REQUEST["course"],$_REQUEST["gender"],$fileName,
$_REQUEST["phone"],$_REQUEST["email"],$_REQUEST["pass"],$conobj);
